...
@PrepareForTest({ ValidTickerServlet.class, HistoricalDataFetcher.class, HistoricalDataSet.class})
...
public class ValidTickerServletTest  extends Mockito {
	@Rule
	...
	public void testDoPostSuccess() throws Exception {
		...
		new ValidTickerServlet().doPost(request, response);
		pw.flush();
	...
	public void testDoPostException() throws Exception {
		when(request.getParameter("ticker")).thenReturn("AAPLLLLLLLL");
		HistoricalDataFetcher hdf = PowerMock.createMock(HistoricalDataFetcher.class);
